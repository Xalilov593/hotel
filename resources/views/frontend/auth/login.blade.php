                    ...
                    <div class="col-xl-4 offset-xl-4 col-md-12 col-12">
                        <div class="text-center">
                            ...
                            <p class="mb-0">
                                ...
                                <a href="{{route('register', app()->getLocale())}}" class="text-primary">Register here</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 col-12">
                        <div class="card shadow-sm mb-6">
                            <div class="card-body">
                                <form class="needs-validation mb-6" novalidate="" action="{{route('loginPost', app()->getLocale())}}" method="POST">
                                    @csrf
                                    <div class="mb-3">
