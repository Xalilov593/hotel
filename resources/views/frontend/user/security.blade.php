                                ...
                                <form class="row needs-validation" novalidate="">
                                    <div class="col-lg-7">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="securityEmailInput"
                                                   placeholder="blocktheme@example.cpm" required="">
                        ...
                        <div class="card border-0 mb-4 shadow-sm">
                            <div class="card-body p-lg-5">
                                <div class="mb-5">
                                    ...
                                    <p class="mb-0 fs-6">We will email you a confirmation when changing your password,
                                        so please
                                ...
                                <form class="row gy-3 needs-validation" novalidate="">
                                    <div class="col-lg-7">
                                        ...
                                        <input type="password" class="form-control" id="securityOldPasswordInput"
                                               required="">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <input type="password" class="form-control" id="securityNewPasswordInput"
                                               required="">
                                        <div class="invalid-feedback">Please enter new password.</div>
                                        <div class="form-text">Make sure it's at least 15 characters OR at least 8
                                            characters
                                    ...
                                    <div class="col-lg-7">
                                        <label for="securityConfirmPasswordInput" class="form-label">Confirm New
                                            Password</label>
                                        <input type="password" class="form-control" id="securityConfirmPasswordInput"
                                               required="">
                        ...
                        <div class="card border-danger bg-danger bg-opacity-10 mb-4 shadow-sm">
                            <div class="card-body p-lg-5">
                                ...
                                <ul class="list-unstyled mb-3">
                                    <li class="mb-2">1. Permanently delete your profile, along with your authentication
                                        associations.
                                    </li>
                                    <li class="mb-2">2. Permanently delete all your content, including your articles,
                                        bookmarks,
