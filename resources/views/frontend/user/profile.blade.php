                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            <div class="card-body p-lg-5">
                                <div class="mb-5">
                                    ...
                                    <p class="mb-0 fs-6">Upload a picture to make your profile stand out and let people
                                        recognize
                                        your comments and contributions easily!</p>
                                </div>
                            ...
                            <div class="card-body p-lg-5">
                                ...
                                <form class="row g-3 needs-validation" novalidate="">
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="profileFirstNameInput" value="Jitu"
                                               required="">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control input-phone" id="profilePhoneInput"
                                               placeholder="+1 4XX XXX XXXX" required="">
