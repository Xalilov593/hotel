...
{{--                                <a href="{{route('about', app()->getLocale())}}" class="btn btn-primary">{{__('main.About')}}</a>--}}
                            </div>
                        </div>
                    </div>
                </div>
