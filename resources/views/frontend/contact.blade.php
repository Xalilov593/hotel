            ...
            <div class="container">
                <div class="row mt-8">
                    <div class="col-lg-6 offset-lg-1 col-md-12 col-12">
                        <h1 class="mb-3">{{__('main.contact')}}</h1>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light">
                                    <div class="card-body p-5">
                                        <h3 class="mb-4">Interested in working
                                            together? Let’s talk. Just Say Hi!</h3>

                                        <form class="needs-validation" novalidate>
                                            <div class="mb-3">
                                                <label for="YourNameInput"
                                                       class="form-label">What’s your
                                                    name</label>
                                                <input type="text"
                                                       class="form-control"
                                                       id="YourNameInput"
                                            ...
                                            <div class="mb-3">
                                                <label for="messageTextarea"
                                                       class="form-label">Describe your
                                                    project</label>
                                                <textarea class="form-control"
                                                          id="messageTextarea"
                                                          placeholder="Write the information about your project."
