<x-layouts.frontend>
        ...
        <div class="container-fluid">
            <div class="content">
                <div class="title-block">
                    <div class="title">
                        <h2 class="h-69">{{__('main.contact')}}</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="page-content" >
        ...
        <div class="contact-us mb-40">
            <div class="container-fluid">
                <div class="contact-wrapper">
                            ...
                            <div class="links">
                                @if($contact->number_1)
                                    <a href="tel:{{$contact->number_1}}">
                                        <div class="contact-box">
                                            ...
                                            <span class="h-18">{{$contact->number_1}}</span>
                                ...
                                <a href="mailto:{{$contact->email_1}}">
                                    <div class="contact-box">
                                        ...
                                        <span class="h-18">{{$contact->email_1}}</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                            <form action="contact.html" method="post" class="contact-form form-validate">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="links input-links">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="Your Name" required="">
                                            <input type="email" id="mail" name="email" class="form-control" placeholder="example@gmail.com" required="">
                                            <input type="text" id="subject" name="subject" class="form-control" placeholder="Subject" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <textarea name="message" id="comment" cols="50" rows="20" class="form-control mb-32" placeholder="Your Comment"></textarea>
                                    </div>
                                    <div class="offset-md-6 col-md-6">
                                        <div class="text-end">
                                            <button type="submit" class="cus-btn review-btn text-end">Send Message</button>
                                            <!-- Alert Message -->
                    ...
                    <div class="social-icons-block mt-24">
                        <a href="">
        ...
        <div class="map-address">
            <div class="container-fluid">
                <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d2995.399481739293!2d69.20344337646162!3d41.343669971305324!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sToshkent%2C%20Ziyo%20ko&#39;chasi%206%20avloniy!5e0!3m2!1suz!2s!4v1734591100980!5m2!1suz!2s" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </div>
